...
class ReportExportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Разовый воркер запускается автоматически листенером RunQueueWorkerOnce
        // (app/Listeners/RunQueueWorkerOnce.php) на событие JobQueued —
        // не нужно повторять exec() тут.
